...
<body>
    ...
    <div class="off-screen-menu">
        ...
        <div class="logo-mon-compte">
            <a class="active" href="#Mon compte">
    ...
    <footer>
        <div class="colonne">
            <div class="footer-logo"> <a href="index.html"><img class="logo" src="./asset/images/logo_white_150.png"
                        alt="Logo" width="150px" height="73px"></a>
